...
function rendreSeance() {
  ...
  ec.innerHTML = `
    ...
    <div class="entete-exo" style="margin-top:14px">
      ...
      <button class="btn fantome" data-exo="${exo.id}" style="padding:8px 10px">Fiche</button>
    </div>
